        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 active" aria-current="page" href="/">Casa</a>
                    </li>
                    <li class="nav-item">
          ...
          <!-- Botón para cesta -->
        <a href="#"><?php echo $__env->make('Modal.modal-carrito', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></a>
...
<!--navbar--><?php /**PATH C:\laragonnew\www\proyect\resources\views/PAGES/Navbar.blade.php ENDPATH**/ ?>